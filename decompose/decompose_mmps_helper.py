...
def write_src_tgt(mmps, name, dir):
    ...
    tgt=[]
    for mmp in mmps:
        src.append(mmp.split(".")[0] + " " + " ".join(".".join((mmp.split(">")[0]).split(".")[2:4])))
        tgt.append(" ".join(mmp.split(">")[1]))
